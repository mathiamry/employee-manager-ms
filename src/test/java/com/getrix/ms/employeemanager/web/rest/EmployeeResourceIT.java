...
import com.getrix.ms.employeemanager.IntegrationTest;
...
class EmployeeResourceIT {
    ...
    void getAllEmployees() throws Exception {
        ...
        restEmployeeMockMvc
            ...
            .andExpect(jsonPath("$.[*].dateOfHiring").value(hasItem(DEFAULT_DATE_OF_HIRING.toString())))
    ...
    void getEmployee() throws Exception {
        ...
        restEmployeeMockMvc
            ...
            .andExpect(jsonPath("$.dateOfHiring").value(DEFAULT_DATE_OF_HIRING.toString()))
