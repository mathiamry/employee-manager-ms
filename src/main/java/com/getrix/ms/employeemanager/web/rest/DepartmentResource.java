package com.getrix.ms.employeemanager.web.rest;

import com.getrix.ms.employeemanager.domain.Department;
import com.getrix.ms.employeemanager.repository.DepartmentRepository;
import com.getrix.ms.employeemanager.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.getrix.ms.employeemanager.domain.Department}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class DepartmentResource {
    ...
    private static final String ENTITY_NAME = "employeeManagerMsDepartment";
