...
import { DepartmentService } from 'app/entities/employeeManagerMS/department/service/department.service';
...
export class EmployeeUpdateComponent implements OnInit {
  ...
  protected updateForm(employee: IEmployee): void {
    this.editForm.patchValue({
      ...
      dateOfHiring: employee.dateOfHiring ? employee.dateOfHiring.format(DATE_TIME_FORMAT) : null,
  ...
  protected createFromForm(): IEmployee {
    return {
      ...
      dateOfHiring: this.editForm.get(['dateOfHiring'])!.value
        ? dayjs(this.editForm.get(['dateOfHiring'])!.value, DATE_TIME_FORMAT)
        : undefined,
